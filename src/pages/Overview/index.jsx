...
export default function Registration() {
    ...
    return (
        <div>
            ...
            <Divider orientation="left" className="dividerStyle">评估信息</Divider>
            <Descriptions bordered >
                <Descriptions.Item label="评估结果：" >{info.evaluationStatus == 1 ? "通过" : "不通过"}</Descriptions.Item>
                {info.evaluationStatus == 1 ? "" : <Descriptions.Item label="不通过原因：">{info.reason}</Descriptions.Item>}
            </Descriptions>
            {info.evaluationStatus == 0 ? "" : <div><Divider orientation="left" className="dividerStyle">收款人信息</Divider>
                <Descriptions bordered>
                ...
                <Descriptions bordered>
                    <Descriptions.Item label="报销金额：">{info.reimbursementAmount}元</Descriptions.Item>
